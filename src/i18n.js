const dictionaries = {
  en: {
    ...
    "method.texDirectHelp": "Typesets XDV directly to vector slides without producing a PDF.",
    ...
    "progress.texDetail": "Generating slide vectors from XDV without creating a PDF.",
    ...
    "file.texMeta": "Beamer TeX · direct XDV vector rendering without PDF",
  ...
  ko: {
    ...
    "method.texDirectHelp": "PDF를 만들지 않고 XDV에서 벡터 슬라이드를 직접 생성합니다.",
    ...
    "progress.texDetail": "PDF를 만들지 않고 XDV에서 슬라이드 벡터를 생성하고 있습니다.",
    ...
    "file.texMeta": "Beamer TeX · PDF 없는 직접 XDV 벡터 렌더링",
